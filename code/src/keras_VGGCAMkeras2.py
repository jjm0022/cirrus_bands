...
model.add(ZeroPadding2D((1, 1)))
model.add(Conv2D(128, (3, 3), activation='relu'))      #layer 7
model.add(MaxPooling2D((2, 2), strides=(2, 2)))
...
model.add(Conv2D(256, (3, 3), activation='relu'))
model.add(ZeroPadding2D((1, 1)))
model.add(Conv2D(256, (3, 3), activation='relu'))      #layer 13
model.add(MaxPooling2D((2, 2), strides=(2, 2)))
...
model.add(Conv2D(512, (3, 3), activation='relu'))
model.add(ZeroPadding2D((1, 1)))
model.add(Conv2D(512, (3, 3), activation='relu'))      #layer 19
model.add(MaxPooling2D((2, 2), strides=(2, 2)))
...
model.add(Conv2D(512, (3, 3), activation='relu'))
model.add(ZeroPadding2D((1, 1)))
model.add(Conv2D(512, (3, 3), activation='relu'))      #layer 25
