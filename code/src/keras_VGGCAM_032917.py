...
nb_train_samples = len(_hurr) + len(_jet) + len(_mcs) + \
    len(_mlc) + len(_nBands) + len(_other)
nb_val_samples = len(_hurrVal) + len(_jetVal) + len(_mcsVal) + \
    len(_mlcVal) + len(_nBandsVal) + len(_otherVal)
