...
weights_path = '/home/jmiller/Dropbox/cnn_stuff/vgg16_weights.h5'
#top_model_weights_path = 'fc_model.h5'
# dimensions of our images.
img_width, img_height = 256, 256
stop_train = 3

train_data_dir = '/home/jmiller/Dropbox/cnn_stuff/images/keras_train'
validation_data_dir = '/home/jmiller/Dropbox/cnn_stuff/images/keras_val'
...
top_model.add(Dropout(0.5))
act_func='sigmoid'
top_model.add(Dense(1, activation=act_func))
...
if not os.path.exists('/home/jmiller/Dropbox/cnn_stuff/models/{0}'.format(date)):
  os.makedirs('/home/jmiller/Dropbox/cnn_stuff/models/{0}'.format(date))
prefix='/home/jmiller/Dropbox//models/{0}/'.format(date)
...
ax1.plot(epochs,hist.history['val_loss'],color='dodgerblue',linewidth=2.5,label='Validation Loss')
ax1.plot(epochs,hist.history['loss'],color='olive',linewidth=2,label='Training Loss')
ax1.set_ylabel('Loss')
...
ax2.plot(epochs,hist.history['val_acc'],'orangered',linewidth=2.5,label='Validation Accuracy')
ax2.plot(epochs,hist.history['acc'],'firebrick',linewidth=2,label='Training Accuracy')
...
g = open('{0}model_info_{1}.txt'.format(prefix,now),'w')
