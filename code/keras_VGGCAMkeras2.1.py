...
home='/rgroup/dsig/data/transverse/'
...
val_data_dir = home+'/training_data/val/'				#
train_data_dir = home+'/training_data/train/'			#
																#
...
model.add(Conv2D(64, (3, 3), activation='relu', padding='same', name='block1_conv1', 
    input_shape=(256, 256, 3)))                                                         #1
model.add(Conv2D(64, (3, 3), activation='relu', padding='same', name='block1_conv2'))   #2
model.add(MaxPooling2D((2, 2), strides=(2, 2), name='block1_pool'))                     #3

# Block 2
model.add(Conv2D(128, (3, 3), activation='relu', padding='same', name='block2_conv1'))  #4
model.add(Conv2D(128, (3, 3), activation='relu', padding='same', name='block2_conv2'))  #5
model.add(MaxPooling2D((2, 2), strides=(2, 2), name='block2_pool'))

# Block 3
model.add(Conv2D(256, (3, 3), activation='relu', padding='same', name='block3_conv1'))  #7
model.add(Conv2D(256, (3, 3), activation='relu', padding='same', name='block3_conv2'))
model.add(Conv2D(256, (3, 3), activation='relu', padding='same', name='block3_conv3'))  #9
model.add(MaxPooling2D((2, 2), strides=(2, 2), name='block3_pool'))

# Block 4
model.add(Conv2D(512, (3, 3), activation='relu', padding='same', name='block4_conv1')) #11
model.add(Conv2D(512, (3, 3), activation='relu', padding='same', name='block4_conv2'))
model.add(Conv2D(512, (3, 3), activation='relu', padding='same', name='block4_conv3')) #13
model.add(MaxPooling2D((2, 2), strides=(2, 2), name='block4_pool'))

# Block 5
model.add(Conv2D(512, (3, 3), activation='relu', padding='same', name='block5_conv1'))  #15
model.add(Conv2D(512, (3, 3), activation='relu', padding='same', name='block5_conv2'))
model.add(Conv2D(512, (3, 3), activation='relu', padding='same', name='block5_conv3'))  #17

#load the model weights
model.load_weights(weights_path)

# Add GAP layer for CAM
model.add(Conv2D(2, (3, 3), activation='relu', padding='same', name='gap_conv'))
...
if not os.path.exists(home+'/models/{0}/{1}'.format(date,now)):
  os.makedirs(home+'/models/{0}/{1}'.format(date,now))
prefix=home+'/models/{0}/{1}/'.format(date,now)
...
shutil.copyfile(home+'/code/keras_VGGCAM.py',prefix+'keras_VGGCAM.py')
